...
class Database:
    ...
    def get_level(self, guild_id: int, user_id: int) -> sqlite3.Row:
        self.connection.execute(
    ...
    def add_xp(self, guild_id: int, user_id: int, amount: int) -> sqlite3.Row:
    ...
    def level_leaderboard(self, guild_id: int, limit: int = 10) -> list[sqlite3.Row]:
        return list(
            self.connection.execute(
